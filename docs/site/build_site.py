...
T = {
 'ja': dict(lang='ja', base='../', self='https://forifor.github.io/Multibot/ja/', other='../', other_lang='en', other_label='EN',
  ...
  shots_eyebrow='アプリの画面', shots_h='作業は、<wbr>1枚の画面で。', shots_p='お願いしたら、あとは1枚の画面。チームの様子も、できたものも、同じページに並びます。',
  shots=[('ask','お願いする','やってほしいことを、いつもの言葉で書きます。資料を添えたり、予算の上限を決めたりもできます。'),('team','1枚で見渡す','左にチームの様子とやりとり、右にできたもの。誰が何をしたかと成果物を、行き来せずに見られます。'),('results','できたものを読む','できたファイルは文書として読めます。確認の結果を見てから、使う版を選びます。')],
 ...
 'en': dict(lang='en', base='', self='https://forifor.github.io/Multibot/', other='ja/', other_lang='ja', other_label='日本語',
  ...
  shots_eyebrow='The app', shots_h='The work lives on one page.', shots_p='Ask once, then stay on one page. The team and the results sit side by side.',
  shots=[('ask','Ask','Write what you need in your own words. You can attach files and set a budget limit.'),('team','See it all at once','The team and its conversation on the left, the results on the right. No switching between screens.'),('results','Read the results','Files read as documents. Look at what was checked, then choose the version you will use.')],
