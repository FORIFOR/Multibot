...
>
> **Local evaluation:** Ollama trials exposed review, tool-recovery, source-input, artifact-ownership and completion-state bugs. Fixes pass 76 regression tests. Some real-model artifacts still passed the basic grader while failing source checks; broader local comparison is pending. [Fixes](docs/evidence/local-fixes-2026-09-14/README.md) · [Local model results and limitations](docs/evidence/local-qwen35-9b-2026-09-14/README.md).
>
