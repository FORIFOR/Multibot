...
const L = lang === 'en'
  ? { start: 'Start', timeline: 'Timeline', report: 'Final report', prompt: 'System prompt', brand: 'Agent Team', settingsNav: 'Settings' }
  : { start: '開始', timeline: '時系列', report: '最終報告', prompt: 'システムプロンプト', brand: 'Agent Team', settingsNav: '設定' }
...
try {
  ...
  await page.click(`button:has-text("${L.prompt}")`)
